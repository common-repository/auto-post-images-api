		...
		class KKAutoPostImages {
			...
			*/
			function printAdminPage () {
				...
				$aPHPInstallInfo = get_loaded_extensions();

				//echo '<pre>'.print_r($aPHPInstallInfo, TRUE).'</pre>';

				if ( !in_array('gd', $aPHPInstallInfo) ) {

				     // GD is not enabled

				     $sPHPInstallInfo = '<div class="error"><p><strong>ERROR: PHP GD library is missing. Thumbnail generation requires PHP GD library to be enabled. Please check your PHP configuration (php.ini) if the extension (php_gd2.dll) is enabled.</strong></p></div>';
				}
						...
						<div class=\"kkwrap\">
							...
							<form method=\"post\" action=\"{$sRequestUri}\">
								...
								<div class=\"tabbertab\">
									...
									<h3>Thumbnails are not working...</h3>

									<p>
										Check if PHP GD library is enabled in you PHP installation.
									</p>

									<h3>How to configure the path and URL settings?</h3>

									<div>
										<p>
										If this is my installation/folder setup:
										<ul class=\"kkadminul\">
											<li>Wordpress install dir: C:/work/webroot/htdocs/wordpress/</li>
											<li>The URL to my wordpress: http://localhost/wordpress/</li>
											<li>The &quot;Auto Post Images (API)&quot; plugin dir: C:/work/webroot/htdocs/wordpress/wp-content/plugins/auto-post-images-api</li>
											<li>Where I upload my images: C:/work/webroot/htdocs/wordpress/wp-content/plugins/my-images</li>
											<li>My folder for thumbnails: C:/work/webroot/htdocs/wordpress/wp-content/plugins/my-images/thumbs</li>
											<li>My folder for thumbnail cache: C:/work/webroot/htdocs/wordpress/wp-content/plugins/my-images/thumbs</li>
										</ul>

										Then this is my plugin configuration:
										<ul class=\"kkadminul\">
											<li>Image directory? : <strong>C:/work/webroot/htdocs/wordpress/wp-content/plugins/my-images/</strong></li>
											<li>Thumbnail directory? : <strong>C:/work/webroot/htdocs/wordpress/wp-content/plugins/my-images/thumbs/</strong></li>
											<li>Cache directory? (Used by the thumbnail creator) : <strong>C:/work/webroot/htdocs/wordpress/wp-content/plugins/my-images/thumbs/</strong></li>
											<li>Image directory URL? : use either relative or absolute path for the URL like so:<br /><strong>wp-content/plugins/my-images/</strong> <br />or <br /><strong>http://localhost/wordpress/wp-content/plugins/my-images/</strong></li>
											<li>Thumbnail directory URL? : use either relative or absolute path for the URL like so:<br /><strong>wp-content/plugins/my-images/thumbs/</strong> <br />or <br /><strong>http://localhost/wordpress/wp-content/plugins/my-images/thumbs/</strong></li>
										</ul>
			...
			function rerunImagesProcesses() {
				...
				//echo '<pre>Thumbnails to delete from ', $this->sImageThumbnailDirPath, ' - ', print_r($aThumbnails, TRUE), '</pre>';

				foreach($aThumbnails as $sThumbnailPath) {

					//echo "<p>Deleting thumb file - {$this->sImageThumbnailDirPath}/{$sThumbnailPath}</p>";
				...
				foreach($aImages as $sImagePath) {
					...
					//echo "<p>Processing image - {$this->sImageDirPath} {$sImagePath}</p>";
				...
				*/
				...
				//echo '<pre>Images for processing - ', print_r($aImageTypes, TRUE), '</pre>';
